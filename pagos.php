        ...
        <div class="row">
            ...
            <div class="col-4">
                <form class="d-flex">
                    ...
                    <button class="btn btn-outline-success" type="button" onclick="buscarCategoria()">Search</button>
                </form>
            </div>
        </div>
...
<div class="container mt-5" >
    <div class="row">
        <div class="col-4" id="divPago">
            <fieldset disabled>
                <h4 class="alert alert-primary" role="alert">TIPO PAGO</h4>
                <div class="mb-3">
                    <h6>SERVICIO SUSCRITO</h6>
                    <input type="text" id="servicioSuscrito" class="form-control" placeholder="Disabled input">
                </div>
                <div class="mb-3">
                    <h6>CATEGORIA</h6>
